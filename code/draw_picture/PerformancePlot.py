...
fig, axs = plt.subplots(3, 4,figsize=(12,9),sharex=False, sharey=False)
title = ['GNN+XGBoost', 'GNN+DT', 'GNN+RF', 'GNN+GBRT']
title_train = ['a', 'b', 'c', 'd']
title_test = ['e', 'f', 'g', 'h']
title_error = ['i', 'j', 'k', 'l']
colors = ['#829ACA',  '#F78769','#61BFA6', '#DD85B8']
methods = ['XGB','DT','RF','GBRT']
